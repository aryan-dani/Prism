...
16. **Water-conservation estimator** — EPA WaterSense / Fix-a-Leak liters/day note on leak/drip/running-toilet Support answers (`water_math.py`). See `decisions.md` §12.  
17. **Landing page** — headline, six domain cards, four-step how-it-works, curated demo questions.  
